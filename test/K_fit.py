...
MM energy file	the relative energy of a molecule for different conformations (with respect to the most stable) calculated with K's parameters set to 0. Values (in kJ/mol -
